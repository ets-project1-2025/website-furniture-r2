...
const $$New = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (Astro2.request.method === "POST") {
    ...
    const { data: newGallery, error: insertError } = await supabase.from("lookbook_galleries").insert([{
      title,
      description,
...
}, "/workspaces/website-furniture-r2/src/pages/admin/lookbooks/new.astro", void 0);

const $$file = "/workspaces/website-furniture-r2/src/pages/admin/lookbooks/new.astro";
const $$url = "/admin/lookbooks/new";
